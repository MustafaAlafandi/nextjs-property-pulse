...
function ProfilePage() {
  ...
  if (process.env.NEXT_PUBLIC_REGESTRING_ADDED === "true") {
    ...
    profileName = process.env.NEXT_PUBLIC_TEST_PROFILE_NAME;
    profileEmail = process.env.NEXT_PUBLIC_TEST_PROFILE_EMAIL;
    profileImage = process.env.NEXT_PUBLIC_TEST_PROFILE_IMAGE;
  }
  return (
    // <!-- Profile Section -->
