...
function FeaturedPropertyCard({ property }: { property: propertyProps }) {
  const { rates } = property;
  let stringPrice = rates.monthly
    ? String(rates.monthly) + "/mo"
    : rates.weekly
    ? String(rates.weekly) + "/wk"
    : rates.nightly
    ? String(rates.nightly) + "/nt"
    : "N/A";
