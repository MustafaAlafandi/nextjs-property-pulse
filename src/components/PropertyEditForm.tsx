...
function PropertyEditForm() {
  ...
  const [fields, setFields] = useState(addPropertyFormDefaultInputs);
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        if (propertyData && propertyData.rates) {
          ...
          console.log("newPropertyData",propertyData);
        }
        setFields(propertyData);
      } catch (err) {
        toast.error("Could not fetch property previous data");
        console.error(err);
      } finally {
        setLoading(false);
      }
          ...
          {amenities.map((ele, index) => (
            <AmenityCheckBox
              ...
              amenity={{
                ...
                changeHandler: handleAmenitiesChange,
              }}
            />
          ))}
        </div>
